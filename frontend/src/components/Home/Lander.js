  ...
  return (
    <div className="flex items-center min-h-screen-90 bg-black">
      <div className="container mx-auto">
        <div className="mx-auto my-10 rounded-none md:rounded-md shadow-sm">
          <div className="mx-5 my-7 md:mx-7 text-center">
            <div className=" mx-auto  bg-black py-16 md:py-24">
              <div className="grid grid-cols-1">
                <div className="my-auto text-center">
                  <span className="header text-white text-5xl md:text-6xl block mb-16 px-8 md:px-20 lg:px-16 xl:px-32 2xl:px-96">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 mt-16">
                    <div>
                      ...
                      <span className="text-gray-400 text-sm font-light block px-6 lg:px-16">
                        ...
                        obsessive focus on end-user performance. Our platform
